...
[
	...
	[
		...
		([[_this, 5, false, [false]] call BIS_fnc_param] call AdenisServer_fnc_bool),
		([[_this, 6, [], [[]]] call BIS_fnc_param] call AdenisServer_fnc_mresArray),
		...
		([[_this, 12, [], [[]]] call BIS_fnc_param] call AdenisServer_fnc_mresArray),
		([[_this, 13, [], [[]]] call BIS_fnc_param] call AdenisServer_fnc_mresArray),
		([_this, 14, "none", [""]] call BIS_fnc_param),
		([[_this, 15, [], [[]]] call BIS_fnc_param] call AdenisServer_fnc_mresArray),
		([[_this, 16, [], [[]]] call BIS_fnc_param] call AdenisServer_fnc_mresArray),
		str([_this, 1, sideUnknown, [civilian]] call BIS_fnc_param),
		([_this, 2, 0, [0]] call BIS_fnc_param),
		([_this, 3, 0, [0]] call BIS_fnc_param),
		([[_this, 4, [], [[]]] call BIS_fnc_param] call AdenisServer_fnc_mresArray),
		([[_this, 17, [], [[]]] call BIS_fnc_param] call AdenisServer_fnc_mresArray),
		([_this, 0, "", [""]] call BIS_fnc_param),
		([[_this, 18, [], [[]]] call BIS_fnc_param] call AdenisServer_fnc_mresArray),
		([_this, 19, 0, [0]] call BIS_fnc_param),
		([[_this, 20, false, [false]] call BIS_fnc_param] call AdenisServer_fnc_bool)
	], 1
