...
_object = getText(missionConfigFile >> "ADENIS_COMPANIES_BUILDINGS" >> getText(missionConfigFile >> "ADENIS_COMPANIES_TYPES" >> _type >> "building") >> "bedrock") createVehicle _position;
