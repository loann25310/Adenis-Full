		...
		if (_x getVariable ["construction", false]) then
		{
			[
				...
				[
					...
					_bank,
					[(_x getVariable ["construction_require", []])] call AdenisServer_fnc_mresArray,
					(_info select 3)
				], 1
			...
			[
				...
				[
					...
					_bank,
					(_info select 3),
					[(_x getVariable ["company_members", []])] call AdenisServer_fnc_mresArray,
					[(_x getVariable ["company_inv_virtual", []])] call AdenisServer_fnc_mresArray,
					(_info select 1),
					[(_x getVariable ["company_inv_arma", []])] call AdenisServer_fnc_mresArray,
