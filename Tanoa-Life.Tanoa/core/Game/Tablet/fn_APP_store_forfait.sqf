...
(_display displayCtrl 8109) buttonSetAction "[] call AdenisClient_fnc_APP_store_forfait_buy;";
...
_list ctrlSetEventHandler ["LBSelChanged", "_this call AdenisClient_fnc_APP_store_forfait_update;"];
