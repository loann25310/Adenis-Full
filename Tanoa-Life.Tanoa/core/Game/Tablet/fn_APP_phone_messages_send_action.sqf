...
_data = [(ctrlText 8334), ([(ctrlText 8336), ","] call CBA_fnc_split), (cbChecked ((findDisplay 7500) displayCtrl 8338))] call AdenisClient_fnc_phone_message_send;
...
if (_sent > 0) then
{
	...
	[_info] call AdenisClient_fnc_info;
} else {
	[_info] call AdenisClient_fnc_error;
};
