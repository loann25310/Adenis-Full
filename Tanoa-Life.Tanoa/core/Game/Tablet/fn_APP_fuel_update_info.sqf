...
[
	...
	+	"</t>",
	[[_station, _fuel] call AdenisClient_fnc_fuelStation_fuel_getPrice] call AdenisClient_fnc_numberText,
	[_station, _fuel] call AdenisClient_fnc_fuelStation_fuel_getStock
];
