...
playSound "buy";
[false, _price, format["Licence (%1)", ([_license] call AdenisClient_fnc_licenseGetName)]] call AdenisClient_fnc_handleATM;
["STORE_LICENSES"] spawn AdenisClient_fnc_tabletApp;
