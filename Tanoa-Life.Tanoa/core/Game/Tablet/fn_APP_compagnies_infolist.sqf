...
{
	_index = _list lbAdd format["%1 - Prix : %2$ - Licence : %3", getText(_x >> "name"), [getNumber(_x >> "price")] call AdenisClient_fnc_numberText, [getText(_x >> "license")] call AdenisClient_fnc_licenseGetName];
