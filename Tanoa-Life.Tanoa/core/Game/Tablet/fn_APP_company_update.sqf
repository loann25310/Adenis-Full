...
{
	[9607, false] call AdenisClient_fnc_tabletShow;
	[9608, false] call AdenisClient_fnc_tabletShow;
	[9609, false] call AdenisClient_fnc_tabletShow;
	[9610, false] call AdenisClient_fnc_tabletShow;
	[9611, false] call AdenisClient_fnc_tabletShow;
	[9612, false] call AdenisClient_fnc_tabletShow;
};
