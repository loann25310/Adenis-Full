...
_ctrl_sms ctrlSetEventHandler ["LBSelChanged", "[((_this select 0) lbData (_this select 1)), true] call AdenisClient_fnc_phone_ring_message;"];
...
_ctrl_call ctrlSetEventHandler ["LBSelChanged", "[((_this select 0) lbData (_this select 1)), true] call AdenisClient_fnc_phone_ring_call;"];
...
_ctrl_checkbox ctrlSetEventHandler ["CheckedChanged", "[(_this select 1)] call AdenisClient_fnc_phone_annuaire;"];
