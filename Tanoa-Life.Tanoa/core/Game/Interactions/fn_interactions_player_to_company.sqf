...
[
	...
	[
		[
			"search",
			"Perquisition",
			"[g_interaction_target,'company'] spawn AdenisClient_fnc_item_perquisition;",
			"
			...
			"info",
			"Infos",
			"[g_interaction_target] call AdenisClient_fnc_company_info_open;",
			"
				!(g_interaction_target getVariable ['construction',false])
			"
		],[
			"book",
			"Livre Comptes",
			"[g_interaction_target,player] remoteExecCall ['AdenisServer_fnc_company_history_get',2];",
			"
				!(g_interaction_target getVariable ['construction',false]) &&
				(
					...
					(
						...
						(
							...
							(
								...
								([getText(missionConfigFile >> 'ADENIS_FACTIONS' >> str(playerSide) >> 'companies' >> 'history' >> 'license')] call AdenisClient_fnc_hasLicense)
							)
						)
					)
				)
			...
			"finish",
			"Construire",
			"[g_interaction_target] spawn AdenisClient_fnc_company_construction_build;",
			"
				(g_interaction_target getVariable ['construction',false]) &&
				((g_interaction_target getVariable ['construction_require',[]]) isEqualTo []) &&
				(['company_construction'] call AdenisClient_fnc_hasLicense)
			"
		],[
			"process",
			"Traitements",
			"[g_interaction_target] call AdenisClient_fnc_company_process;",
			"
				!(g_interaction_target getVariable ['construction',false]) &&
			...
			"inventory",
			"Coffre",
			"[g_interaction_target] spawn AdenisClient_fnc_company_storage;",
			"
			...
			"inventory",
			"Ouverte/Fermée",
			"[g_interaction_target] spawn AdenisClient_fnc_company_changeStatus;",
			"
				!(g_interaction_target getVariable ['construction',false]) && (g_company isEqualTo g_interaction_target)
			"
		],[
			"garage",
			"Garage",
			"[g_interaction_target] call AdenisClient_fnc_company_garage;",
			"
			...
			"store",
			"Rentrer",
			"[g_interaction_target] spawn AdenisClient_fnc_garageStoreOpen;",
			"
				isClass(missionConfigFile >> 'ADENIS_COMPANIES_TYPES' >> ((g_interaction_target getVariable 'company_info') select 2) >> 'garage') &&
				!(g_interaction_target getVariable ['construction',false]) &&
				(g_company isEqualTo g_interaction_target)
			...
			"launder",
			"Blanchiment",
			"[g_interaction_target] spawn AdenisClient_fnc_company_launder_open;",
			"
				(g_company isEqualTo g_interaction_target) &&
				((['illegal_money'] call AdenisClient_fnc_itemCount) > 0) &&
				!(g_interaction_target getVariable ['construction',false])
			"
		],[
			"destroy",
			"Détruire",
			"[g_interaction_target] spawn AdenisClient_fnc_company_destroy;",
			"
				...
				(
					...
					(
						...
						([getText(missionConfigFile >> 'ADENIS_FACTIONS' >> str(playerSide) >> 'companies' >> 'destroy' >> 'license')] call AdenisClient_fnc_hasLicense)
					)
				)
			"
		],[
			"light",
			"Lumière",
			"[g_interaction_target] call AdenisClient_fnc_building_light_handle;",
			"
				(g_company isEqualTo g_interaction_target) ||
				(
					(getNumber(missionConfigFile >> 'ADENIS_FACTIONS' >> str(playerSide) >> 'companies' >> 'search') isEqualTo 1) &&
			...
			"lock",
			"Serrure",
			"[g_interaction_target,false] call AdenisClient_fnc_building_door_lock_handle;",
			"
				(([g_interaction_target] call AdenisClient_fnc_nearestDoor) != 0) &&
				(
			...
			"knock",
			"Toquer",
			"[g_interaction_target] call AdenisClient_fnc_building_door_knock;",
			"
				(([g_interaction_target] call AdenisClient_fnc_nearestDoor) != 0) &&
				((g_interaction_target animationPhase format['door_%1_rot',(([g_interaction_target] call AdenisClient_fnc_nearestDoor) != 0)]) isEqualTo 0)
			"
		],[
			"bell",
			"Sonner",
			"[g_interaction_target] call AdenisClient_fnc_building_door_doorbell;",
			"
				(([g_interaction_target] call AdenisClient_fnc_nearestDoor) != 0) &&
				((g_interaction_target animationPhase format['door_%1_rot',(([g_interaction_target] call AdenisClient_fnc_nearestDoor) != 0)]) isEqualTo 0)
			"
			...
			"lock",
			"Crochetter",
			"[g_interaction_target,true] spawn AdenisClient_fnc_building_door_lock_handle;",
			"
