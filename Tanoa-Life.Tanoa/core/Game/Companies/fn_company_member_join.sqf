...
{
	[format["Vous avez rejoint l'entreprise : <t color='#74DF00'>%1</t>.", (_info select 0)]] call AdenisClient_fnc_info;
	[_company, true, (getPlayerUID player), profileName] call AdenisClient_fnc_company_member_handle;
	g_company = _company;
	...
	[format["Vous êtes déjà membre de l'entreprise : <t color='#74DF00'>%1</t>.<br/>Contactez <t color='#045FB4'>%2</t> et demandez-lui de quitter l'entreprise.", (_actual select 0), (_actual select 4)]] call AdenisClient_fnc_error;
};
