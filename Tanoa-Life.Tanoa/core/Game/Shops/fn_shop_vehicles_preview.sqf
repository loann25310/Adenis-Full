...
if (_className isEqualTo "") exitWith {
	["Impossible de récupérer les informations du véhicule."] call AdenisClient_fnc_error;
};

closeDialog 0;

_handle = [_className] spawn AdenisClient_fnc_vehiclePreview;
waitUntil {scriptDone _handle};

[nil, nil, nil, [g_shop_vehicles_type, g_shop_vehicles_spawn]] call AdenisClient_fnc_shop_vehicles_open;
