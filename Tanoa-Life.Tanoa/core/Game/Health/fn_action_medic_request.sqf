...
if (player getVariable ["is_coma", false]) then
{
	...
	[format["Nouvelle demande de soin en <t color='#01DF01'>%1</t>.", (mapGridPosition player)], "CENTRAL", false] remoteExecCall ["AdenisClient_fnc_phone_message_receive", independent];
};
