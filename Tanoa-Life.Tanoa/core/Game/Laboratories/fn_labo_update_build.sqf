...
if (isNull _object) exitWith {
	["Impossible de récupérer le laboratoire venant d'être construit."] call AdenisClient_fnc_error;
};
...
if (isNil "_config") exitWith {
	["Impossible de récupérer les informations du laboratoire venant d'être construit."] call AdenisClient_fnc_error;
};
