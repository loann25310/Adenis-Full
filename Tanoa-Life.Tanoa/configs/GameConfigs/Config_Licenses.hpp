class ADENIS_LICENSES
{
	...
	{
		name="Membre du Parti Travailleur Italien";
		class factions
		{
			class CIV
			{
	...
	class company_bank
	{
		...
		class factions
		{
			...
			{
				price=7500;
				condition="!(isNull g_company) && {(((g_company getVariable ['company_info',['','','']]) select 2) isEqualTo 'banque')}";
				search_shown[]={"WEST","EAST","GUER","CIV"};
			};
		};
	};
	...
	class traitement_barrecereales
	{
		name="Traitement des barres de céréales";
		class factions
		{
			class CIV
			{
	...
	class traitement_meubles
	{
		name="Traitement des meubles";
		class factions
		{
			class CIV
			{
